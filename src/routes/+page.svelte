...
<section class="grid grid-cols-1 gap-4 md:grid-cols-3">
	<div class="flex flex-col items-center gap-4 rounded-box border p-6 text-center">
		...
		<h3 class="text-xl font-bold">Top Rated Bars & Brews</h3>
		<p class="text-lg text-gray-600">Explore the best rated beers and pubs - wherever you are!</p>
	</div>
	...
	<div class="flex flex-col items-center gap-4 rounded-box border p-6 text-center">
		...
		<p class="text-lg text-gray-600">
			Join our community of beer lovers and share your favourites or discover something new!
		</p>
	</div>
	...
	<div class="flex flex-col items-center gap-4 rounded-box border p-6 text-center">
		...
		<h3 class="text-xl font-bold">Awesome Deals</h3>
		<p class="text-lg text-gray-600">
			With the most up to date prices and deals, we help you to save money!
		</p>
	</div>
</section>
